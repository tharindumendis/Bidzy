...
namespace Bidzy.Application.Repository.Notification
{
    public class NotificationRepository : INotificationRepository
    {
        ...
        public async Task<PagedResult<Domain.Entities.Notification>> GetNotificationsByUserIdAsync(Guid userId, int page, int pageSize)
        {
            ...
            return new PagedResult<Domain.Entities.Notification>
            {
        ...
        public async Task<IEnumerable<Domain.Entities.Notification>> GetUnseenNotificationsByUserIdAsync(Guid userId)
        {
            return await dbContext.Notifications
        ...
        public async Task AddNotificationAsync(Domain.Entities.Notification notification)
        {
            await dbContext.Notifications.AddAsync(notification);
            await dbContext.SaveChangesAsync ();
        }
        public async Task AddNotificationsAsync(List<Domain.Entities.Notification> notifications)
        {
