...
namespace Bidzy.API.Controllers.Payments
{
    ...
    public class PaymentController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetByUser([FromRoute] Guid userId, [FromQuery] string role = "buyer")
        {
            ...
            IEnumerable<Payment> list = role.Equals("seller", StringComparison.OrdinalIgnoreCase)
        ...
        private static PaymentDto ToDto(Domain.Entities.Payment p) => new PaymentDto
        {
            Id = p.Id,
            BidId = p.BidId,
